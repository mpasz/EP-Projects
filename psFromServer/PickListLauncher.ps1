#
# PickListLauncher.ps1
#
Clear-Host
function preCheck($pfcCompany)
{
    $select="SELECT ""DocEntry"" FROM ORDR WHERE IFNULL(""U_CreateSendOrder"",'N') = 'T'  ORDER BY ""DocEntry""" 
...
$SCRIPT_FILE_NAME = $PSScriptRoot + "\PickList_RD_ReleasedQty.ps1"
