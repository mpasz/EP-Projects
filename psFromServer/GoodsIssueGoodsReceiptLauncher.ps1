#
# GoodsIssueGoodsReceiptLauncher.ps1
#
    Clear-Host
function preCheck($pfcCompany)
{
    $select="SELECT ""Code"" FROM ""@PWRW"" WHERE ""U_STATUS"" = 'C'"
...
$SCRIPT_FILE_NAME = $PSScriptRoot + "\GoodsIssueGoodsReceipt.ps1"
