#
# MorFromGoodsReceiptLauncher.ps1
#
Clear-Host
function preCheck($pfcCompany)
{
    $select="select DL.""DocEntry"" from IGN1 DL WHERE DL.""U_Niezaplanowane"" != 'N' AND DL.""U_Niezaplanowane"" != 'S'"
...
$SCRIPT_FILE_NAME = $PSScriptRoot + "\MorFromGoodsReceipt.ps1"
